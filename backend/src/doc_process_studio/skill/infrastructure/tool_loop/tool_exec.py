...
async def _execute_builtin_tool(
    *,
    ...
    if tool_name == "search_knowledge_base":
        ...
        from ....knowledge_base.infrastructure.embedding import embed_texts
        from ....knowledge_base.infrastructure.qdrant_service import search_knowledge_base as kb_search
