...
from ..router.schemas import KBFolderResponse, KBTreeNode, KBTreeNodeDocument, KBTreeNodeFolder
from .persistence import KBFolder, KBProject
...
async def build_tree(db: AsyncSession, project_id: str) -> list[KBTreeNode]:
    ...
    from .persistence import KBDocument
