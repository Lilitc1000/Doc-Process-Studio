...
# 字符串键版本（供 infrastructure 层 ORM 种子数据使用）
...
PERMISSION_DEFINITIONS: list[dict[str, str]] = [
    {
        ...
        "description": "创建新的事故报告",
        "category": "report",
    },
    {
        "permission_key": "report:edit_own",
        "permission_name": "编辑自己的报告",
        "description": "编辑自己创建的草稿或被驳回的报告",
        "category": "report",
    },
    {
        "permission_key": "report:edit_all",
        "permission_name": "编辑所有报告",
        "description": "编辑任意状态的任意报告",
        "category": "report",
    },
    {
        "permission_key": "report:submit",
        "permission_name": "提交审核",
        "description": "将报告提交审核",
        "category": "report",
    },
    {
        "permission_key": "report:view",
        "permission_name": "查看报告",
        "description": "查看报告列表和详情",
        "category": "report",
    },
    {
        "permission_key": "report:view_all",
        "permission_name": "查看所有报告",
        "description": "查看所有用户的报告",
        "category": "report",
    },
    {
        "permission_key": "report:edit_assigned",
        "permission_name": "编辑被指派的报告",
        "description": "编辑被指派给自己处理的报告",
        "category": "report",
    },
    {
        "permission_key": "report:close_assigned",
        "permission_name": "关闭被指派的报告",
        "description": "关闭被指派给自己处理的报告",
        "category": "report",
    },
    {
        "permission_key": "report:audit",
        "permission_name": "审核报告",
        "description": "审核待审核报告（批准/驳回）",
        "category": "report",
    },
    {
        "permission_key": "report:assign",
        "permission_name": "分配处理人",
        "description": "为已批准的报告分配处理人",
        "category": "report",
    },
    {
        "permission_key": "report:delete",
        "permission_name": "删除报告",
        "description": "删除任意状态的报告",
        "category": "report",
    },
    {
        "permission_key": "report:reopen",
        "permission_name": "重新打开报告",
        "description": "重新打开已关闭的报告",
        "category": "report",
    },
    {
    ...
    {
        "permission_key": "system:config",
        "permission_name": "系统配置",
        "description": "事故报告系统配置管理",
        "category": "system",
    },
    {
        "permission_key": "data:export",
        "permission_name": "数据导出",
        "description": "导出事故报告数据",
        "category": "data",
    },
    {
        "permission_key": "analytics:view",
        "permission_name": "查看统计分析",
        "description": "查看事故报告统计分析数据",
        "category": "analytics",
    },
]
