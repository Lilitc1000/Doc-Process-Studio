...
from ....auth.infrastructure.persistence.user import User
...
from ...application.ports.role_ports import RoleRepository
from ...domain.values.permission import (
    PERMISSION_DEFINITIONS,
    ROLE_DEFINITIONS,
    ROLE_PERMISSIONS_MAP,
    VALID_ROLES,
)
from ..persistence.incident_report_role import (
