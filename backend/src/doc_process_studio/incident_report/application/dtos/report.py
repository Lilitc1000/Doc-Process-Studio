...
包含报告摘要、详情、审计日志、评论等端口返回数据结构。
infrastructure 层的仓储实现返回这些 DTO，application 层的端口接口声明它们。
"""
...
from ...domain.values.status_types import IncidentReportStatus, IncidentSeverity
from .form import IncidentFormAnswer
