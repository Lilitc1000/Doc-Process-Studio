...
from ...common.infrastructure.model_context import estimate_prompt_tokens, get_model_context_length
from ...common.infrastructure.ollama import OllamaNotConfiguredError, stream_chat_completion
from ...common.middleware.request_guard import RequestGuardError, guard_request_slot
from ...common.utils.dtutils import to_utc8
from ...common.utils.error_utils import build_error_event_detail, summarize_exception
from ...common.utils.tool_args import build_normalized_tool_calls
from ...skill.application.dtos.catalog import SkillInterfaceConfig
from ...skill.application.dtos.runtime import (
    ConversationAgentState,
    SkillConversationState,
    SkillPlanDecision,
)
from ...skill.infrastructure.conversation_store import load_conversation_state, save_conversation_state
from ...skill.infrastructure.registry import (
    get_skill_interface,
    list_skill_interfaces,
)
from ...skill.infrastructure.runtime import sync_skill_context_state
from ...skill.infrastructure.selector import select_for_chat_skills
from ...skill.infrastructure.tool_loop import (
    build_skill_tools,
...
from ...system.infrastructure.utils.executor import (
    ExecutionBudget,
    ExecutionInput,
    ExecutorDeps,
    execute_tool_graph,
