...
from doc_process_studio.services.skill.registry import (
    SKILLS_DIR,
    get_skill_interface,
...
def test_all_skill_dirs_are_registered_and_have_openai_config() -> None:
    ...
    # 目录中的所有 skill 都应进入注册表，否则说明某个 openai 配置缺失或解析失败。
